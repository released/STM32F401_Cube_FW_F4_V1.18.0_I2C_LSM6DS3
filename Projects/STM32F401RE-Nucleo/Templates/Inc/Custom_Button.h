...
#define BTN4_GPIO_CLK()         	__HAL_RCC_GPIOA_CLK_ENABLE()
#define BTN4_PIN                  	GPIO_PIN_0

#define Button4Data					(HAL_GPIO_ReadPin(BTN4_GPIO_PORT,BTN4_PIN))

#elif defined (STM32F401_NUCLEO)	//STM32F4 NUCLEO
#define BTN4_GPIO_PORT          	GPIOC
#define BTN4_GPIO_CLK()         	__HAL_RCC_GPIOC_CLK_ENABLE()
